...
const SplashingScreen = ({ navigation }) => {
  ...
  return (
    <ImageBackground source={require('./src/assets/back/back5.png')} style={{flex: 1}}>
      <View style={{flex: 1, alignItems: 'center', justifyContent: 'space-between', paddingTop: height * 0.03, paddingBottom: height * 0.1}}>
          <Image source={require('./src/assets/icons/logoGate.png')} style={{ width: '100%', height: '100%', resizeMode: 'cover', marginTop:50}} />
...
const App = () => {
//<MusicProvider></MusicProvider><Player />
  return (
